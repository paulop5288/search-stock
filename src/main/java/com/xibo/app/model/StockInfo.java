...
public class StockInfo implements Serializable {
    ...
    public boolean isLimitUp() {
        if (!isInTrading() || prevStock == null) return false;
        if (secShortName.contains("ST")) {
            return closePrice / prevStock.getClosePrice() > 1.049;
        }
        return closePrice / prevStock.getClosePrice() > 1.099;
    }
